			...
			<div class="contentInfo">
				...
				<div class="company">
					<p>
						...
						<span>고객센터 | 서울특별시 서초구 서초대로 117 (방배동,용전빌딩1층 101호)<br></span>
						<span>대표전화 | 1666-1282</span>
						<span>이메일 | service@illycaffe.co.kr </span><br>
	                    <span>통신판매업신고번호 : 2010-서울강남-00589</span>
	                    <span>사업자등록번호 : 129-81-19361 <a href="#" class="btn_licensee_info" onclick="gd_popup_bizInfo('1298119361'); return false;">사업자번호조회</a></span>
					</p>
				</div>
...
<!-- ===== ===== ===== jquery START ===== ===== ===== -->
	...
	<script type="text/javascript">
		$('.contact').find('a').hover(
			function(){
				$(this).css('src', '/images/footer/follow-facebook-over.png');
			}, function(){
				$(this).css('src', '/images/footer/follow-facebook.png');
			}
		);
		$('.facebookImg').hover(
				function(){
