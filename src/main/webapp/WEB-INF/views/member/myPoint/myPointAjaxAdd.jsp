...
<div class="myPage_breakdown_tab">
	<ul>
		<li class="setStart same">
			<a>
				<span>사용내역</span>
			</a>
		</li>
		<li class="on getCancel same">
			<a>
				<span>적립내역</span>
			</a>
		</li>
...
<%-- <c:if test="${empty list}"> --%>
	<span class="pick_list_num"><strong id="startendDate"></strong> 까지의 일리 포인트 적립내역 총<strong></strong>건</span>
	<div class="myPage_type_table">
		<table>
			...
			<tbody>
				<tr><td colspan="4"><div class="emptyList"><span>조회내역이 없습니다.</span></div></td></tr>
			</tbody>
		</table>	
	</div>
<%-- </c:if>		
<c:if test="${!empty list}">												
 		<span class="pick_list_num"><strong id="startendDate"></strong> 까지의 일리 포인트 사용내역 총<strong></strong>건</span>
		<div class="myPage_type_table">
			<table>
			<colgroup>
				<col style="width:15%"> 
