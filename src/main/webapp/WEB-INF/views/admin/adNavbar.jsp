...
<body>
	...
	<div class="gnbHeadWrap">
		...
		<div class="gnbTop">
			...
			<a class="tempBtn" href="/"	style="filter: grayscale(100%);">illy CAFFE</a>
		...
		<div class="gnbBottom">
			...
			<div class="logo">
				<a href="/"><img style="filter: grayscale(100%);" alt=""
					src="/images/gnb/logo50.jpg"></a>
			</div>

			<div class="menuWrap">
				<ul>
					<li class="menu"><a
						href="/admin/list?product_categoryCode=001">COFFEE</a>
						<ul class="hoverMenu">
							<li><a href="/admin/insertCoffee">상품등록</a></li>
							<br>
							<li><a href="/admin/list?product_categoryCode=001">상품목록(수정/삭제)</a></li>
						</ul></li>
					<li class="menu"><a
						href="/admin/list?product_categoryCode=002">MACHINE</a>
						<ul class="hoverMenu">
							<li><a href="/admin/insertMachine">상품등록</a></li>
							<br>
							<li><a href="/admin/list?product_categoryCode=002">상품목록(수정/삭제)</a></li>
						</ul></li>
					<!-- 					<li><a href="/admin/insertAccessories">ACCESSORIES</a></li> -->
					<li><a href="/admin/board/adNoticeList">BOARD</a></li>
				</ul>
				<div class="backHome">
					<a href="/"><i class="xi-home">&nbsp;Go Client Page</i></a>
				</div>
			</div>
